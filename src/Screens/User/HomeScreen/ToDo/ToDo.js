...
const ToDo = props => {
  ...
  useEffect(() => {}, [Task.tasks.isLoading]);

  useEffect(() => {
    if (focused) {
      //because focuse set to false when hide
  ...
  const shift = () => {
    ...
    if (Task.tasks.progress != null) Task.setTasks({type: 'RESET_PROGRESS'});
                ...
                <FlatList
                  ...
                  ListFooterComponent={
                    ...
                    dayNumber == currentDayNumber ? (
                      <TouchableOpacity
                        style={styles.extraAddButtonContainer}
                        onPress={() =>
                          props.navigation.navigate('ExtraItem', {
                            dayNumber: dayNumber,
                            goal_id: Goal.goal.data.id,
                          })
                        }>
                      ...
                      <View
                        style={[
                          styles.extraAddButtonContainer,
